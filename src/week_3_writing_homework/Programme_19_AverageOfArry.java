...
public class Programme_19_AverageOfArry {
    public static void main(String[] args) {
        //Numeric array declaration
        int[] numArray = {1789,2035,1899,2040,195,2255,7897,1455,787};
        int sum = 0;
        ...
        System.out.println("Value of elements of the array are : " + Arrays.toString(numArray));
